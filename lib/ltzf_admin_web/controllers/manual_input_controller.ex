defmodule LtzfAdminWeb.ManualInputController do
  ...
  def create_vorgang(conn, %{"vorgang" => vorgang_params}) do
  ...
  def create_sitzung(conn, %{"sitzung" => sitzung_params}) do
  ...
  def create_dokument(conn, %{"dokument" => dokument_params}) do
  ...
  def create_gremium(conn, %{"gremium" => gremium_params}) do
  ...
  def create_autor(conn, %{"autor" => autor_params}) do
