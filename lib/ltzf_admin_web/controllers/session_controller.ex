defmodule LtzfAdminWeb.SessionController do
  ...
  def new(conn, _params) do
    render(conn, :new, layout: {LtzfAdminWeb.Layouts, :clean})
  end
  ...
  def create(conn, %{"session" => session_params}) do
    case Accounts.authenticate_user(session_params["email"], session_params["password"]) do
      ...
      {:error, _reason} ->
        ...
        |> render(:new, layout: {LtzfAdminWeb.Layouts, :clean})
    end
  end
  ...
  def register(conn, _params) do
    ...
    render(conn, :register, changeset: changeset, is_first_user: is_first_user, layout: {LtzfAdminWeb.Layouts, :clean})
  end
