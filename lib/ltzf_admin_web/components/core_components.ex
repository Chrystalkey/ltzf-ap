defmodule LtzfAdminWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: LtzfAdminWeb.Gettext
        ...
        <div class="flex justify-between h-16">
          <div class="flex">
            ...
            <div class="hidden sm:ml-6 sm:flex sm:space-x-4">
              ...
              <a href="/api_keys" class={[
                "inline-flex items-center px-4 py-2 rounded-md text-sm font-medium border shadow-sm transition-all duration-200",
                if(@current_page == "api_keys", do: "bg-indigo-100 text-indigo-700 border-indigo-200 hover:bg-indigo-200 hover:text-indigo-800", else: "bg-white text-gray-700 border-gray-300 hover:bg-gray-50 hover:text-gray-900"),
                "focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
              ]}>
                <svg class="mr-2 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LtzfAdminWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LtzfAdminWeb.Gettext, "errors", msg, opts)
    end
  end
